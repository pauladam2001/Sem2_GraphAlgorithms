...
from LowestCostDijkstra import LowestCostDijkstraLab3
import sys
...
class UI:
    def __init__(self):
        # self._graph = Graph()
        self._graph = LowestCostDijkstraLab3()
    ...
    def lowest_cost_Dijkstra(self):
        source_vertex = int(input('Source vertex: '))
        target_vertex = int(input('Destination vertex: '))
        dist, prev = self._graph.Dijkstra(source_vertex, target_vertex)
        print('The cost is ' + str(dist[target_vertex]))
        path = self._graph.getPath(source_vertex, target_vertex, prev)
        print('The vertices are:' + str(path))
    ...
    def print_menu(self):
        ...
        print('19. Find a lowest cost walk between 2 vertices, using the Dijkstra algorithm.')
        print('\n\n')
